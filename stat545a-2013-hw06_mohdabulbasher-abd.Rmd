...
* Download the following files, from [Github](https://github.com/atante/Stat-545a-2013-HW.git), into an empty directory:
...
* You might need to right click on a file to see or to download it on your machine.
